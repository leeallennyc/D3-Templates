d3.json('/data/ml-sums.json').then(data => {
    const years = data.mlSumsByYear;
    ...
    const applicationsText = svg.append('g')
        ...
        .text('Abstract Contains Machine Learning')
    ...
    const yAxis = svg.append('g')
        ...
        .text('# of Granted Machine Learning Patents Sampled by Year')
